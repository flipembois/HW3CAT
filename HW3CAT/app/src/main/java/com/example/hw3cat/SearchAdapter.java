...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public SearchAdapter(List<Cat> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        dbUtil = new DBUtil(view.getContext());
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mFavView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(holder.mView.getContext(), "Add Fav :"+holder.mItem.getBreeds().get(0).getName(), Toast.LENGTH_SHORT).show();
                dbUtil.add(holder.mItem);
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mFavView = view.findViewById(R.id.iv_fav);
        }
